...
|----|----------|-------------|
| Q1 | Medical Condition vs Age Distribution of Patients |  Expected: Children represent ~2-3% of hospital admissions. Though rarely hospitalised for adult-onset conditions like (hypertension=11, diabetes=16, arthritis=21).
